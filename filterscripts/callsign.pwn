...
// tinggal sesuaikan sedikit dengan gamemode yang kalian gunakan, agar fitur ini hanya bisa digunakan oleh faction 
// skrip ini gratis tidak untuk diperjual belikan, jika ada yg memperjual belikan silahkan laporkan di discord saya.
...
{
	SendClientMessage(playerid,COLOR_ORANGE,"INFO: {FFFFFF}callsign connected");
	return 1;
}
